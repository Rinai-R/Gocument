...
var file_document_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x03, 0x52, 0x65, 0x73, 0x32, 0x9c, 0x01, 0x0a, 0x08, 0x44, 0x6f, 0x63, 0x75,
...
var file_document_proto_depIdxs = []int32{
	...
	1, // 3: Document.Create:output_type -> CreateResponse
	3, // 4: Document.Delete:output_type -> DeleteResponse
	5, // 5: Document.Check:output_type -> CheckPermissionResponse
